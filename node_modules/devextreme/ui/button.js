...
var ALLOWED_STYLE_CLASSES = [BUTTON_STYLING_MODE_CLASS_PREFIX + "contained", BUTTON_STYLING_MODE_CLASS_PREFIX + "text", BUTTON_STYLING_MODE_CLASS_PREFIX + "outlined"];
...
var Button = Widget.inherit({
    ...
    _initTemplates: function() {
        ...
        this._defaultTemplates.content = new FunctionTemplate(function(options) {
            ...
            var $textContainer = data && data.text ? $("<span>").text(data.text).addClass(BUTTON_TEXT_CLASS) : void 0;
    ...
    _getContentData: function() {
        ...
        var back = "back" === this.option("type");
        if (back && !icon) {
            icon = "back"
        }
        return {
