...
var KeyboardNavigationController = _uiGrid_core2.default.ViewController.inherit({
    ...
    _clickHandler: function(e) {
        ...
        var data = event.data;
        var focusedViewElement = data.view && data.view.element();
        ...
        (0, _iterator.each)(that._focusedViews, function(index, view) {
            if (view) {
                view.renderCompleted.add(function(e) {
                    ...
                    var keyboardActionSelector = ".".concat(ROW_CLASS, " > td, .").concat(ROW_CLASS);
                    ...
                    _events_engine2.default.off($rowsView, _utils2.default.addNamespace(_pointer2.default.down, "dxDataGridKeyboardNavigation"), clickAction);
                    _events_engine2.default.on($rowsView, _utils2.default.addNamespace(_pointer2.default.down, "dxDataGridKeyboardNavigation"), keyboardActionSelector, {
                        viewIndex: index,
                        view: view
                    }, clickAction);
    ...
    _getFocusedViewByElement: function($element) {
        var condition = function(view) {
            return $element && $element.closest(view._$element).length
        };
