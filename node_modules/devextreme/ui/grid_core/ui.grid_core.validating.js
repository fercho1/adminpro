            ...
            if (isFull) {
                (0, _iterator.each)(editingController._editData, function(index, editData) {
                    if (editData.type && "remove" !== editData.type) {
                        var validationResult = that.validateGroup(editData);
            ...
            editing: {
                ...
                _getInvisibleColumns: function(editData) {
                    ...
                    if (this.isCellOrBatchEditMode()) {
                        hasInvisibleRows = editData.some(function(rowEditData) {
                            var rowIndex = _this._dataController.getRowIndexByKey(rowEditData.key);
                            return rowIndex < 0
                        })
                    }
                ...
                _beforeSaveEditData: function(editData, editIndex) {
                    ...
                    if (editData) {
                        ...
                        var isFullValid = validatingController.validate(true);
                        disposeValidators();
                    ...
                    _showRevertButton: function($container, $targetElement) {
                        ...
                        var tooltipOptions = {
                            ...
                            contentTemplate: function() {
                                ...
                                var buttonOptions = {
                                    icon: "revert",
                                    hint: _this2.option("editing.texts.validationCancelChanges"),
                                    onClick: function() {
                                        _this2._editingController.cancelEditData()
                                    }
                                };
                    ...
                    _showValidationMessage: function($cell, message, alignment, revertTooltip) {
                        ...
                        var overlayOptions = {
                            ...
                            onPositioned: function(e) {
                                _this3._positionedHandler(e, isOverlayVisible);
                                _this3._shiftValidationMessageIfNeed(e.component.$content(), revertTooltip && revertTooltip.$content(), $cell)
                            }
                        };
            ...
            rowsView: {
                ...
                _formItemPrepared: function(cellOptions, $container) {
                    ...
                    (0, _common.deferUpdate)(function() {
                        ...
                        if (!isEditorDisposed) {
                            _this4.getController("validating").createValidator(cellOptions, $editor)
                        }
                    })
                },
