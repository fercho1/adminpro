    ...
    return {
        ...
        _navigateToVisibleRow: function(key, deferred, needFocusRow) {
            if (needFocusRow) {
                ...
                var rowElement = rowsView.getRow(rowIndex);
        ...
        _triggerUpdateFocusedRow: function(key, deferred) {
            var dataController = this.getController("data");
            var focusedRowIndex = this._getFocusedRowIndexByKey(key);
        ...
        controllers: {
            ...
            data: {
                ...
                _fireChanged: function(e) {
                    ...
                    var skipFocusedRowNavigation = this.option("skipFocusedRowNavigation");
        ...
        views: {
            rowsView: {
                ...
                _setFocusedRowElementTabIndex: function() {
                    ...
                    var rowElement = that._findRowElementForTabIndex();
                    if (rowElement) {
