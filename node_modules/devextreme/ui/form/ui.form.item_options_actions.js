    ...
    _createClass(TabOptionItemOptionAction, [{
        ...
        value: function() {
            ...
            if (tabPanel) {
                ...
                if (itemIndex >= 0) {
                    tabPanel.option("items[".concat(itemIndex, "].").concat(optionName), value);
                    return true
                }
            }
            return false
...
var ValidationRulesItemOptionAction = function(_ItemOptionAction3) {
    ...
    var _super3 = _createSuper(ValidationRulesItemOptionAction);
...
var CssClassItemOptionAction = function(_ItemOptionAction4) {
    ...
    var _super4 = _createSuper(CssClassItemOptionAction);
