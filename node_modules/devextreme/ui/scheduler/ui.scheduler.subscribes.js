...
var subscribes = {
    ...
    getResizableAppointmentArea: function(options) {
        ...
        var isGrouped = groups && groups.length;
        if (isGrouped) {
    ...
    correctAppointmentCoordinates: function(options) {
        ...
        var containerSign = options.isFixedContainer ? -1 : 1;
        var scrollTop = this.getWorkSpaceScrollableScrollTop(isAllDay);
        var allDayPanelTopOffset = !isAllDay ? this.getWorkSpaceAllDayOffset() : 0;
        var headerHeight = this.getWorkSpaceHeaderPanelHeight();
        var scrollLeft = this.getWorkSpaceScrollableScrollLeft();
        var tableLeftOffset = this.getWorkSpaceDateTableOffset();
        var topOffset = -scrollTop + allDayPanelTopOffset + headerHeight;
        var leftOffset = -scrollLeft - tableLeftOffset;
        options.callback({
    ...
    getFullWeekAppointmentWidth: function(options) {
        var groupIndex = options.groupIndex;
        var groupWidth = this._workSpace.getGroupWidth(groupIndex);
