...
var TooltipStrategyBase = exports.TooltipStrategyBase = function() {
    ...
    _createClass(TooltipStrategyBase, [{
        ...
        value: function(data, currentData, color) {
            ...
            var isAllDay = this.scheduler.fire("getField", "allDay", data);
            var text = this.scheduler.fire("getField", "text", data);
            var startDateTimeZone = this.scheduler.fire("getField", "startDateTimeZone", data);
            var endDateTimeZone = this.scheduler.fire("getField", "endDateTimeZone", data);
            var startDate = this.scheduler.fire("convertDateByTimezone", this.scheduler.fire("getField", "startDate", currentData), startDateTimeZone);
            var endDate = this.scheduler.fire("convertDateByTimezone", this.scheduler.fire("getField", "endDate", currentData), endDateTimeZone);
