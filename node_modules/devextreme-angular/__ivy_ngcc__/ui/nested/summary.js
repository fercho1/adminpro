...
DxoSummaryComponent.ɵfac = function DxoSummaryComponent_Factory(t) { return new (t || DxoSummaryComponent)(ɵngcc0.ɵɵdirectiveInject(nested_option_1.NestedOptionHost, 5), ɵngcc0.ɵɵdirectiveInject(nested_option_1.NestedOptionHost, 1)); };
DxoSummaryComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxoSummaryComponent, selectors: [["dxo-summary"]], contentQueries: function DxoSummaryComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, group_item_dxi_1.DxiGroupItemComponent, false);
        ɵngcc0.ɵɵcontentQuery(dirIndex, total_item_dxi_1.DxiTotalItemComponent, false);
    } if (rf & 2) {
        var _t;
    ...
    } }, inputs: { calculateCustomSummary: "calculateCustomSummary", groupItems: "groupItems", recalculateWhileEditing: "recalculateWhileEditing", skipEmptyValues: "skipEmptyValues", texts: "texts", totalItems: "totalItems" }, features: [ɵngcc0.ɵɵProvidersFeature([nested_option_1.NestedOptionHost]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 0, vars: 0, template: function DxoSummaryComponent_Template(rf, ctx) { }, styles: [""] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DxoSummaryComponent, [{
        ...
        args: [{
            ...
            args: [core_1.forwardRef(function () { return group_item_dxi_1.DxiGroupItemComponent; })]
        }], totalItemsChildren: [{
            type: core_1.ContentChildren,
            args: [core_1.forwardRef(function () { return total_item_dxi_1.DxiTotalItemComponent; })]
        }] }); })();
