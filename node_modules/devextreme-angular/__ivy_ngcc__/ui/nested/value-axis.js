...
DxoValueAxisComponent.ɵfac = function DxoValueAxisComponent_Factory(t) { return new (t || DxoValueAxisComponent)(ɵngcc0.ɵɵdirectiveInject(nested_option_1.NestedOptionHost, 5), ɵngcc0.ɵɵdirectiveInject(nested_option_1.NestedOptionHost, 1)); };
DxoValueAxisComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxoValueAxisComponent, selectors: [["dxo-value-axis"]], contentQueries: function DxoValueAxisComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, constant_line_dxi_1.DxiConstantLineComponent, false);
        ɵngcc0.ɵɵcontentQuery(dirIndex, strip_dxi_1.DxiStripComponent, false);
    } if (rf & 2) {
        var _t;
    ...
    } }, inputs: { allowDecimals: "allowDecimals", axisDivisionFactor: "axisDivisionFactor", categories: "categories", color: "color", constantLines: "constantLines", constantLineStyle: "constantLineStyle", discreteAxisDivisionMode: "discreteAxisDivisionMode", endOnTick: "endOnTick", grid: "grid", inverted: "inverted", label: "label", logarithmBase: "logarithmBase", maxValueMargin: "maxValueMargin", minorGrid: "minorGrid", minorTick: "minorTick", minorTickCount: "minorTickCount", minorTickInterval: "minorTickInterval", minValueMargin: "minValueMargin", opacity: "opacity", showZero: "showZero", strips: "strips", stripStyle: "stripStyle", tick: "tick", tickInterval: "tickInterval", type: "type", valueMarginsEnabled: "valueMarginsEnabled", valueType: "valueType", visible: "visible", width: "width", max: "max", min: "min" }, features: [ɵngcc0.ɵɵProvidersFeature([nested_option_1.NestedOptionHost]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 0, vars: 0, template: function DxoValueAxisComponent_Template(rf, ctx) { }, styles: [""] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DxoValueAxisComponent, [{
        ...
        args: [{
            ...
            args: [core_1.forwardRef(function () { return constant_line_dxi_1.DxiConstantLineComponent; })]
        }], stripsChildren: [{
            type: core_1.ContentChildren,
            args: [core_1.forwardRef(function () { return strip_dxi_1.DxiStripComponent; })]
        }] }); })();
...
DxoValueAxisModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: DxoValueAxisModule });
DxoValueAxisModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DxoValueAxisModule_Factory(t) { return new (t || DxoValueAxisModule)(); } });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DxoValueAxisModule, { declarations: [DxoValueAxisComponent], exports: [DxoValueAxisComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DxoValueAxisModule, [{
